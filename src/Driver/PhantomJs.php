...
namespace mglaman\WebDriver\Driver;
...
class PhantomJs extends RemoteWebDriver {

  public static function start(DesiredCapabilities $desired_capabilities = null, DriverService $service = null)
  {
    if ($desired_capabilities === null) {
      $desired_capabilities = DesiredCapabilities::chrome();
    }
    if ($service === null) {
      $service = new DriverService('phantomjs', 4444);
    }
  ...
  public static function create(
    ...
    throw new WebDriverException('Please use PhantomJs::start() instead.');
  }
